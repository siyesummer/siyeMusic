...
class Upload
{
	public $picfile_dir   = "../../source/picture/";//图片文件存储路径
	public $musfile_dir   = "../../source/music/";//音乐音频文件存储路径
	public $radiofile_dir = "../../source/radio/";//电台音频文件存储路径
	...
	function uploadFile($file,$dao,$radio)
	{
		...
		else if($this->isAudio($file))
		{
			...
			// $file['name'] = str_replace(".wav","",$file['name']);
			if($file['name']=="")
			{
				$file['name']=".mp3";
			}
